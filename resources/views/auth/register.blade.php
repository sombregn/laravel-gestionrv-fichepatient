...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" id="divbg">
        ...
        <div class="container-fluid" >
            <br>
            <div class="container col-md-7 text-center" id="nameapp">
                <h4 class="text-primary">HOSPITAL APP</h4>
            </div>
            <br>
            <div class="container col-md-5">
                <div class="card">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Nom complet<span class="required">*</span></label>
                                <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Email<span class="required">*</span></label>
                                    <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Mot de passe<span class="required">*</span></label>
                                    <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Confirmez le mot de passe<span class="required">*</span></label>
                                                <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Adresse<span class="required">*</span></label>
                                                <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Téléphone<span class="required">*</span></label>
                                                <div>
                                                    <input type="text" class="form-control" placeholder="Téléphone..." data-inputmask="'mask' : '(+221) 99-999-9999'" name="telephone" required>
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Genre</label>
                                                <div>
                            ...
                            <div class="mt-4">
                                <label class="col-form-label label-align">Date de naissance<span class="required">*</span></label>
                                                <div>
                                                    <input class="form-control" class='date' type="date" name="date_de_naissance" required>
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align">Groupe sanguin<span class="required">*</span></label>
                                                <div>
                                                    <input class="form-control" type="text" name="groupe_sanguin" required placeholder="Groupe sanguin...">
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Antecedents medicaux<span class="required">*</span></label>
                                                <div>
                                                    <input class="form-control" type="text" name="antecedents_medicaux" required placeholder="Antecedents medicaux...">
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Assurance maladie<span class="required">*</span></label>
                                                <div>
                                                    <input class="form-control" type="text" name="assurance_maladie" required placeholder="Assurance maladie...">
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Informations d'urgence<span class="required">*</span></label>
                                                <div>
                                                    <input class="form-control" type="text" name="informations_urgence" required placeholder="Informations d'urgence...">
                                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="col-form-label label-align h6">Photo<span class="required">*</span></label>
                                                <div>
                        ...
                        <div class="card-footer text-center">
                            <button type="submit" class="btn btn-secondary" id="btnconnect">Se connecter</button>
                        </div>
                    </form>
                </div>
                <br>
