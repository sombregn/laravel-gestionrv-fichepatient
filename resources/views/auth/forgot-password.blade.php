                    ...
                    <div class="card-body" style="border: none; border-color: #fff;">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div>
                                ...
                                <input id="email" type="email" name="email" class="form-control" placeholder="Votre email..." :value="old('email')" required autofocus>
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary">
                                    {{ __('Lien de recuperation de mot de passe') }}
                                </button>
                            </div>
                        </form>
                    </div>
