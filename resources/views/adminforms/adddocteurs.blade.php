                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="" action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="horaires_de_consultation" required placeholder="Horaire de consultation...">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="specialite" required placeholder="Spécialité...">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
