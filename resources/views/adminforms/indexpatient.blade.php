                        ...
                        <div class="page-title">
                            ...
                            <div class="title_right">
                                ...
                                <div class="input-group">
                                    <form action="{{ route('patient.search') }}" method="GET" class="input-group">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>ANTECEDANT MEDICAUX</th>
                          <th>ASSURANCE MALADIE</th>
                          <th>INFORMATION D'URGENCE</th>
                          <th>ACTION</th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        @if (isset($searchResults))
                            ...
                            <tr>
                                ...
                                <td>{{$patient->user->date_de_naissance}}</td>
                                <td>{{$patient->user->groupe_sanguin}}</td>
                                <td>{{$patient->antecedents_medicaux}}</td>
                                <td>{{$patient->assurance_maladie}}</td>
                                <td>{{$patient->information_urgence}}</td>
                                <td>
                                    <a href="{{ route('editpatient',$patient->id)}}" class="btn btn-success">✏</a>
                                    <form method="POST" action="{{route('deletepatient',$patient->id) }}" accept-charset="UTF-8" style="display:inline">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td>{{$patient->antecedents_medicaux}}</td>
                                <td>{{$patient->assurance_maladie}}</td>
                                <td>{{$patient->informations_urgence}}</td>
                                <td>
                                    <a href="{{ route('editpatient',$patient->id)}}" class="btn btn-success">✏</a>
                                    <form method="POST" action="{{route('deletepatient',$patient->id) }}" accept-charset="UTF-8" style="display:inline">
                                        {{ method_field('DELETE') }}
                                    ...
                                    <div class="text-center">
                                        <ul class="pagination">
                                            ...
                                            @if ($patients->currentPage() > 1)
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $patients->previousPageUrl() }}" rel="prev">&laquo;</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($patients->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $patients->nextPageUrl() }}" rel="next">&raquo;</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
