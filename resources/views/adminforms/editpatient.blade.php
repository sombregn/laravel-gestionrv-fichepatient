                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        @endif
                                        <form class="" action="" method="POST" enctype="multipart/form-data" action="{{route('updatepatient',['id'=>$patient->id])}}">
                                            @csrf
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Nom complet<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input  type="text" class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" value="{{ $patient->user->name }}" placeholder="Nom complet..." required autofocus autocomplete="name" />
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Email<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="email" class='email' required type="email" value="{{ $patient->user->email }}" placeholder="Email..." autocomplete="username" />
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" id="password_confirmation" name="password_confirmation"  type="password" autocomplete="new-password" placeholder="Confirmez le mot de passe..." value="{{$patient->password_confirmation}}"/>
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="adresse" placeholder="Adresse..." required type="text" value="{{$patient->user->adresse}}"/>
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Téléphone<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input type="text" class="form-control" placeholder="Téléphone..." data-inputmask="'mask' : '(+221) 99-999-9999'" name="telephone" required value="{{$patient->user->telephone}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <select class="form-control" name="genre" required>
                                                        ...
                                                        <option value="{{ $genre }}" {{ $genre == $patient->user->genre ? 'selected' : '' }}>
                                                            {{ $genre }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" class='date' type="date" name="date_de_naissance" required value="{{$patient->user->date_de_naissance}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align">Groupe sanguin<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="groupe_sanguin" required placeholder="Groupe sanguin..." value="{{$patient->user->groupe_sanguin}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Antecedents medicaux<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="antecedents_medicaux" required placeholder="Horaire de consultation..." value="{{$patient->antecedents_medicaux}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Assurance maladie<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="assurance_maladie" required placeholder="Spécialité..." value="{{$patient->assurance_maladie}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Informations d'urgence<span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" type="text" name="informations_urgence" required placeholder="Spécialité..." value="{{$patient->informations_urgence}}">
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align h6">Photo<span class="required" value="{{$patient->photo}}">*</span></label>
                                                <div class="col-md-6 col-sm-6">
