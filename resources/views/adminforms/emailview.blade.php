                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Veuillez saisir votre mail</h2>
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ url('emailview', $data->id) }}">
                                            @csrf
                                            ...
                                            <div class="item form-group">
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input value="Veuillez cliquer sur le lien ci-après pour acceder à votre historique" type="text" id="first-name" class="form-control" name="cliquesurlurl" hidden>
                                                </div>
                                            </div>
