                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Formulaire de modification de bâtiments</h3>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        @endif
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{route('editbatiment',['id'=>$batiment->id])}}">
                                            @csrf
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" id="first-name" class="form-control" name="nom" value="{{$batiment->nom}}">
                                                </div>
                                            </div>
