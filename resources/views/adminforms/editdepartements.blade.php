                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Formulaire de modification de départements</h3>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        @endif
                                        <form class="form-horizontal form-label-left" method="POST" action="{{route('editdepartement',['id'=>$departement->id])}}">
                                            @csrf
                                            <div class="form-group row ">
                                                <label class="control-label col-md-3 col-sm-3 h6 ">Nom du département*</label>
                                                <div class="col-md-9 col-sm-9 ">
                                                    <input type="text" class="form-control col-md-10" placeholder="Nom du département..." name="nom" value="{{$departement->nom}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3 col-sm-3 h6 ">Téléphone du département*</label>
                                                <div class="col-md-9 col-sm-9 ">
                                                    <input type="text" class="form-control col-md-10" placeholder="Téléphone du département..." data-inputmask="'mask' : '(+221) 99-999-9999'" name="telephone" value="{{$departement->telephone}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3 col-sm-3 h6 ">Email du département*</label>
                                                <div class="col-md-9 col-sm-9 ">
                                                    <input type="email" name="mail"  placeholder="Email du département..." class="form-control col-md-10" value="{{$departement->mail}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3 col-sm-3 h6 ">Heurs de visite*</label>
                                                <div class="col-md-9 col-sm-9 ">
                                                    <input type="text" name="heures_de_visite" id="autocomplete-custom-append" placeholder="Heurs de visite..." class="form-control col-md-10" value="{{$departement->heures_de_visite}}"/>
                                                </div>
                                            </div>
                                            <!---<div class="form-group row">
                                                ...
                                                <div class="col-md-9 col-sm-9 ">
                                                    <select class="form-control col-md-10" name="service_id">
                                                        @foreach($services as $service)
                                                            <option value="{{ $service->id }}" {{ $service->id == $departement->service_id ? 'selected' : '' }}>
                                                                {{ $service->nom }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-9 col-sm-9 ">
                                                    <select class="form-control col-md-10" name="batiment_id">
                                                        @foreach($batiments as $batiment)
                                                            <option value="{{ $batiment->id }}" {{ $batiment->id == $departement->batiment_id ? 'selected' : '' }}>
                                                                {{ $batiment->nom }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 col-sm-9 ">
                                                    ...
                                                    <input type="text" class="form-control col-md-10" placeholder="Description..." name="description" value="{{$departement->description}}">
                                                </div>
                                            </div>
                                            <div class="control-group row">
                                                <label class="control-label col-md-3 col-sm-3 h6 ">Services offerts</label>
                                                <div class="col-md-9 col-sm-9 ">
                                                    <input id="tags_1" type="text" class="form-control col-md-10" name="services_offerts" value="{{$departement->services_offerts}}"/>
                                                </div>
                                            </div>
